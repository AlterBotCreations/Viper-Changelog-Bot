...
var _a, _LatestSlashCommand_getChangelogFromGitHub, _LatestSlashCommand_getChangelogEmbed;
...
class LatestSlashCommand {
    static execute(interaction) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield __classPrivateFieldGet(this, _a, "m", _LatestSlashCommand_getChangelogFromGitHub).call(this, url);
